...
def create_tqa_assistant(apps, schema_editor):
    User = apps.get_registered_model('auth', 'User')
    tqa_assistant = User(
        pk=1,
        username='导学小助手',
        email='wuyinan0126@gmail.com',
        password=make_password('cat'),
        is_superuser=True,
        is_staff=True
    )
    tqa_assistant.save()
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags',
                 taggit.managers.TaggableManager(to='taggit.Tag', through='taggit.TaggedItem', help_text='逗号分割的标签列表',
                                                 verbose_name='标签')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user',
                 annoying.fields.AutoOneToOneField(primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL,
